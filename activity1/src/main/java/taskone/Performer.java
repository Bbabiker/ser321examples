...
class Performer {
    ...
    public JSONObject add(String str) {
        JSONObject json = new JSONObject();//creates a json object with the new string
        json.put("datatype", 1);
        json.put("type", "add");
        state.add(str);//add to the list
        json.put("data", state.toString());
        return json;
    }

    /**
     * pop a specified string from the list head
     * @return
     */
    ...
    /**
     * switch to string at a specified indexes
     * @param s
     * @return
     */
